...
package com.redrock.elan.common.core.util.annotation;

import java.lang.reflect.Field;

import javax.xml.bind.ValidationException;

import com.redrock.elan.common.core.util.StringUtils;
...
public class ValidateUtils {
	...
	public static void validate(Field field, Object object) throws ValidationException {
		...
		Object value=null;
		// 获取对象的成员的注解信息
		dv = field.getAnnotation(Validate.class);
		try {
