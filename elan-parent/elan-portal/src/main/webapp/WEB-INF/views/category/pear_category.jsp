		...
		<div class="white-bg">
			...
			<div class="sort-arat brand-areat">
				<ul>
					...
					<li>
						<input type="checkbox" class="ids" catType="" rel="${row.id }"/>
						<a href="${contextPath }/main/view.html?type=${curSelectedBpp.type.value }&id=${row.id}">
							...
							<c:out value="${row.pointOneShow }" />-<c:out value="${row.pointTwoShow }" />&nbsp;
							<c:out value="${row.circleShow }" />&nbsp;
							<c:out value="${row.qualityShow }" />&nbsp;
							<c:out value="${row.luminosityShow }" />&nbsp;
							<c:out value="${row.nlevelShow }" />&nbsp;
