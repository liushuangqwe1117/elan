...
<div class="container">
    ...
    <div class="row gary-bg">
         ...
         <table class="gdetail">
         	...
         	<tr>
         		<th>品类：</th><td><c:out value="${obj.categoryShow }" /></td>
         		<th class="secondth">款式：</th><td><c:out value="${obj.styleShow }" /></td>
         	</tr>
         	<tr>
         		<th>尺寸：</th><td><c:out value="${obj.nsizeShow }" /></td>
         		<th class="secondth">材质：</th><td><c:out value="${obj.materialShow }" /></td>
         	</tr>
         	<tr>
         		<th>镶嵌：</th><td colspan="2"><c:out value="${obj.weightShow }" /></td>
         	</tr>
         </table>
