...
<div class="container">
    ...
    <div class="row gary-bg">
         ...
         <table class="gdetail">
         	...
         	<tr>
         		<th>点位：</th><td><c:out value="${obj.pointOneShow }" />-<c:out value="${obj.pointTwoShow }" /></td>
         		<th class="secondth">颜色：</th><td><c:out value="${obj.nlevelShow }" /></td>
         	</tr>
         	<tr>
         		<th>形状：</th><td><c:out value="${obj.circleShow }" /></td>
         		<th class="secondth">光泽：</th><td><c:out value="${obj.luminosityShow }" /></td>
         	</tr>
         	<tr>
         		<th>瑕疵度：</th><td><c:out value="${obj.qualityShow }" /></td>
         		<th class="secondth">产地：</th><td><c:out value="${obj.prodPlaceShow }" /></td>
         	</tr>
         	<tr>
         		<th>种类：</th><td colspan="2"><c:out value="${obj.categoryShow }" /></td>
         	</tr>
         </table>
