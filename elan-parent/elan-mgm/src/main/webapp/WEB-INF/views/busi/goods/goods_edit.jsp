...
<body class="p-iframe">
	<div class="m-edit">
		...
		<form:form id="profile_form" class="m-form" action="${contextPath }/goods/save.html" commandName="obj" method="post" enctype="multipart/form-data">
			<ofa:token/>
			<form:hidden path="id"/>
			...
			<div class="ipt">
				...
				<label>*种类：</label>
				<form:select path="category" items="${goodsCategorys }" itemLabel="name" itemValue="id" />
			</div>
			<div class="ipt">
				<label>*款式：</label>
				<form:select path="style" items="${goodsStyles }" itemLabel="name" itemValue="id" />
				<label>排序：</label>
